...
const awards = [
  ...
  },
  {
    ...
    year: '2025',
    desc: 'Awarded at Velammal Odyssey 2025 for exceptional innovation in AI product development (including Simbli AI for DCI), actively contributing to the college AI Club to teach and build AI products, and leading collaborative freelance teams with juniors to build real-world AI applications.',
    image: '/stdnt_innovation_awrd.jpg',
    link: '/student_innovation_award.pdf',
    tags: ['AI Product Innovation', 'AI Club Mentorship', 'Junior Team Freelance', 'GenAI'],
    color: '#8b5cf6',
  },
]
